...
<div class="content-section">
    <div class="content-full">
        <h2>Apa itu PPID?</h2>
        @php
            $pengantarDb = \App\Models\Profil::where('kategori', 'Pengantar')->where('judul', 'Tentang PPID')->first();
        ...
        @endphp
        <p>{!! nl2br(e($pengantar)) !!}</p>
        
        @php
            $profils = \App\Models\Profil::where('is_active', true)->where('kategori', '!=', 'Pengantar')->orderBy('kategori')->orderBy('urutan')->get();
