...
@section('title', 'Profil Pejabat - PPID BBIA')
@section('page-title', 'Edit Halaman Profil Pejabat')
...
<div class="edit-container">
    ...
    <div class="form-section">
        <div class="section-header">
            <h3>👤 Edit Halaman Profil Pejabat PPID</h3>
        </div>
        ...
        <form action="{{ route('admin.profil-pejabat.update') }}" method="POST" id="pejabatForm">
            @csrf
            @method('PUT')
            ...
            @empty
                <div class="alert alert-error">
                    ...
                    <div>
                        <strong>Belum ada data Profil Pejabat</strong>
                        <p style="margin: 0.5rem 0 0 0;">Silakan tambahkan data Profil Pejabat terlebih dahulu melalui menu Profil.</p>
                    </div>
                </div>
            @endforelse
        ...
        <div class="preview-content" id="preview">
            ...
            <div class="profile-card">
                ...
                <div class="profile-info">
                    <h3 id="previewNama">Nama Pejabat</h3>
            ...
            @empty
                <p>Belum ada informasi profil pejabat.</p>
            @endforelse
        </div>
    </div>
</div>
