...
@section('title', 'Tugas dan Fungsi - PPID BBIA')
@section('page-title', 'Edit Halaman Tugas dan Fungsi')
...
<div class="edit-container">
    ...
    <div class="form-section">
        <div class="section-header">
            <h3>📌 Edit Halaman Tugas dan Fungsi PPID</h3>
        </div>
        ...
        <form action="{{ route('admin.tugas-dan-fungsi.update') }}" method="POST" id="tugasForm">
            @csrf
            @method('PUT')
            ...
            @empty
                <div class="alert alert-error">
                    ...
                    <div>
                        <strong>Belum ada data Tugas dan Fungsi</strong>
                        <p style="margin: 0.5rem 0 0 0;">Silakan tambahkan data Tugas dan Fungsi terlebih dahulu melalui menu Profil.</p>
                    </div>
                </div>
            @endforelse
    ...
    <div class="preview-section">
        ...
        <div class="preview-content" id="preview">
            ...
            @empty
                <p>Belum ada konten tugas dan fungsi.</p>
            @endforelse
        </div>
    </div>
</div>
