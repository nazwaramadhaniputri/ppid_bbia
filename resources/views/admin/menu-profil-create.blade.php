...
@section('title', 'Tambah Menu Profil - PPID BBIA')
@section('page-title', 'Tambah Menu Profil Baru')
...
<div class="form-container">
    <div style="margin-bottom: 2rem;">
        <h2 style="margin: 0; color: #1e293b;">➕ Tambah Menu Profil</h2>
        <p style="margin: 0.5rem 0 0 0; color: #64748b;">Tambahkan menu baru yang akan muncul di dropdown Profil pada website publik</p>
    </div>
    ...
    <form action="{{ route('admin.menu-profil.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" id="nama_menu" name="nama_menu" class="form-control" 
                   value="{{ old('nama_menu') }}" required placeholder="Contoh: Tentang PPID">
        ...
        <div class="form-group">
            ...
            <input type="text" id="link" name="link" class="form-control" 
                   value="{{ old('link') }}" required placeholder="Contoh: /tentang-ppid">
            <div class="help-text">
        ...
        <div class="form-group">
            ...
            <input type="number" id="urutan" name="urutan" class="form-control" 
                   value="{{ old('urutan', 1) }}" required min="0" placeholder="1">
            <div class="help-text">
...
// Auto-generate urutan based on existing menus
document.addEventListener('DOMContentLoaded', function() {
    const urutanInput = document.getElementById('urutan');
    if (urutanInput.value === '1') {
        // Fetch existing menus to suggest next order number
        fetch('{{ route("admin.menu-profil.get-next-order") }}')
